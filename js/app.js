...
var CELULAR_EMPRESA = '5591989436288';
...
cardapio.eventos = {
  init: () => {
    ...
    cardapio.metodos.carregarBotaoWhats2();
  },
};
...
cardapio.metodos = {
  obterItensCardapio: (categoria = "burgers", vermais = false) => {
    ...
    $.each(filtro, (i, e) => {
      ...
      if ((vermais && i >= 8 && i < 30) || (!vermais && i < 8)) {
...
diminuirQuantidadeCarrinho: (id) => {
  ...
  let qntdAtual = parseInt($("#qntd-carrinho-" + id).text());
    ...
    if (qntdAtual > 1) {
      ...
      cardapio.metodos.removerItemrCarrinho(id)
    }
      ...
      $.getJSON(`https://viacep.com.br/ws/${cep}/json/?callback=?`)
        .done(function (dados) {
          if (!("erro" in dados)) {
            ...
            cardapio.metodos.mensagem('CEP não encontrado. Preencha as informações corretamente.');
            $("#txtEndereco").focus();
          }
        })
        .fail(function () {
...
cardapio.templates = {
  item: `<div class="col-12 col-lg-3 col-md-3 col-sm-6 mb-5 animated wow fadeIn">
    ...
    <div class="col-12 item-carrinho">
              ...
              <span class="btn btn-remove no-mobile" onclick="cardapio.metodos.removerItemrCarrinho('\${id}')"><i class="fas fa-times"></i></span>
              </div>
            </div> `,
